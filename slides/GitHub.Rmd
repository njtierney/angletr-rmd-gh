...
> Git + GitHub is the most popular version control system for developers of R packages (witness the thousands of R packages hosted on GitHub).
...
- fork
- open in Rstudio
- change the output to `github_document`
- run the document
- commit, push
- look at github
