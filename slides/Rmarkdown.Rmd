...
- Recently submitted PhD in Statistics under [Kerrie Mengersen](https://en.wikipedia.org/wiki/Kerrie_Mengersen) at QUT with BRAG
- Currently a research Fellow in Statistics at Monash University with [Di Cook](http://dicook.org/) and [Rob Hyndman](https://robjhyndman.com/) at [NUMBAT]()
- Active in the [rOpenSci]() community
...
- There are times when learning this material might be 
  frustrating, and that is a totally normal thing, and expected

---

# The good news: 

- This is usually temporary and well worth the effort. 
...
Get the rmarkdown document to run
